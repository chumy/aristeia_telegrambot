...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'ChumyTest1Bot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '845501750:AAGoWNC6_UKsZtKq6WIzZZ58iRWt_eTO9p4'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
                Telegram\Bot\Commands\CrearPartidaCommand::class,
                Telegram\Bot\Commands\ListaPartidasCommand::class,
                Telegram\Bot\Commands\MisPartidasCommand::class,
                Telegram\Bot\Commands\BorrarPartidaCommand::class,
                //Telegram\Bot\Commands\WelcomeCommand::class,
